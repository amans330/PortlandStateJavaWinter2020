...
public class Project4Test extends InvokeMainTestCase{
    ...
    public void testSuccessfullyReadingAndWritingToFile(){
        MainMethodResult result = invokeMain(new String[] {"-textFile", "src/test/resources/edu/pdx/cs410J/aso2/file.txt", "Valid Airlines", "123", "fat", "3/15/2017", "10:39", "pm", "fat", "3/15/2017", "11:00", "pm"});
    ...
    @Test
    public void testWithBothValidTextAndXMLFiles(){
        MainMethodResult result = invokeMain(new String[] {"-textFile", "src/test/resources/edu/pdx/cs410J/aso2/file.txt", "-xmlFile", "src/test/resources/edu/pdx/cs410J/aso2/valid-airline.xml", "-pretty", "-", "Valid Airlines", "101", "CVG", "03/04/2017", "12:36", "pm", "LFT", "03/05/2017", "8:19", "pm"});
        assertThat(result.getTextWrittenToStandardOut(), containsString("It is an error to specify both -textFile and -xmlFile."));
    }

    @Test
    public void malformattedXMLFile(){
        MainMethodResult result = invokeMain(new String[] {"-xmlFile", "src/test/resources/edu/pdx/cs410J/aso2/invalid-airline.xml", "-pretty", "-", "Valid Airlines", "101", "CVG", "03/04/2017", "12:36", "pm", "LFT", "03/05/2017", "8:19", "pm"});
        assertThat(result.getTextWrittenToStandardOut(), containsString("The XML file is Malformatted"));
    }

    @Test
    public void missingXMLPath(){
        MainMethodResult result = invokeMain(new String[] {"-xmlFile", "-pretty", "-", "Valid Airlines", "101", "CVG", "03/04/2017", "12:36", "pm", "LFT", "03/05/2017", "8:19", "pm"});
        assertThat(result.getTextWrittenToStandardOut(), containsString("Please pass the XML file name to read/write from"));
    }

    @Test
    public void everythingIsFine(){
        MainMethodResult result = invokeMain(new String[] {"-xmlFile", "src/test/resources/edu/pdx/cs410J/aso2/valid-airline.xml", "-pretty", "-", "Valid Airlines", "102", "CVG", "03/04/2017", "12:36", "pm", "LFT", "03/05/2017", "8:19", "pm"});
        assertThat(result.getTextWrittenToStandardOut(), containsString("Added data to XML file"));
    }

    @Test
    public void prettyPrintFromXML(){
        MainMethodResult result = invokeMain(new String[] {"-xmlFile", "src/test/resources/edu/pdx/cs410J/aso2/valid-airline.xml", "-pretty", "src/test/resources/edu/pdx/cs410J/aso2/pretty.txt", "Valid Airlines", "102", "CVG", "03/04/2017", "12:36", "pm", "LFT", "03/05/2017", "8:19", "pm"});
        assertThat(result.getTextWrittenToStandardOut(), containsString("Added data to XML file"));
    }

    @Test
    public void xmlHasWrongDate(){
        MainMethodResult result = invokeMain(new String[] {"-xmlFile", "src/test/resources/edu/pdx/cs410J/aso2/xmlwrongdate.xml", "-pretty", "src/test/resources/edu/pdx/cs410J/aso2/pretty.txt", "Valid Airlines", "102", "CVG", "03/04/2017", "12:36", "pm", "LFT", "03/05/2017", "8:19", "pm"});
        assertThat(result.getTextWrittenToStandardOut(), containsString("date is not in the right format"));
    }

    @Test
    public void xmlHasWrongFLightNumber(){
        MainMethodResult result = invokeMain(new String[] {"-xmlFile", "src/test/resources/edu/pdx/cs410J/aso2/xmlwrongflightnumber.xml", "-pretty", "src/test/resources/edu/pdx/cs410J/aso2/pretty.txt", "Valid Airlines", "102", "CVG", "03/04/2017", "12:36", "pm", "LFT", "03/05/2017", "8:19", "pm"});
        assertThat(result.getTextWrittenToStandardOut(), containsString("flight number is not a number"));
    }

    @Test
    public void xmlHasNonExistentAirport(){
        MainMethodResult result = invokeMain(new String[] {"-xmlFile", "src/test/resources/edu/pdx/cs410J/aso2/xmlwrongairportcode.xml", "-pretty", "src/test/resources/edu/pdx/cs410J/aso2/pretty.txt", "Valid Airlines", "102", "CVG", "03/04/2017", "12:36", "pm", "LFT", "03/05/2017", "8:19", "pm"});
        assertThat(result.getTextWrittenToStandardOut(), containsString("Invalid destination airport code"));
    }

    @Test
    public void xmlFileIsEmpty(){
        MainMethodResult result = invokeMain(new String[] {"-xmlFile", "src/test/resources/edu/pdx/cs410J/aso2/empty.xml", "-pretty", "src/test/resources/edu/pdx/cs410J/aso2/pretty.txt", "Valid Airlines", "102", "CVG", "03/04/2017", "12:36", "pm", "LFT", "03/05/2017", "8:19", "pm"});
        assertThat(result.getTextWrittenToStandardOut(), containsString("The XML file provided is Empty"));
    }

    @Test
    public void airlineNameDoesNotMatchWithXML(){
        MainMethodResult result = invokeMain(new String[] {"-xmlFile", "src/test/resources/edu/pdx/cs410J/aso2/valid-airline.xml", "-pretty", "src/test/resources/edu/pdx/cs410J/aso2/pretty.txt", "Valid Airlines 123", "102", "CVG", "03/04/2017", "12:36", "pm", "LFT", "03/05/2017", "8:19", "pm"});
        assertThat(result.getTextWrittenToStandardOut(), containsString("Airline name in the XML file does not match the input"));
    }

    @Test
    public void cannotWriteToXML(){
        MainMethodResult result = invokeMain(new String[] {"-xmlFile", "src/test/resources/edu/pdx/cs410J/aso2/valid-airline.xml", "-pretty", "src/test/resources/edu/pdx/cs410J/aso2/pretty.txt", "Valid Airlines 123", "102", "CVG", "03/04/2017", "12:36", "pm", "LFT", "03/05/2017", "8:19", "pm"});
        assertThat(result.getTextWrittenToStandardOut(), containsString("Airline name in the XML file does not match the input"));
    }
}
